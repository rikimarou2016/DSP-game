...
{
   // Add in socket connection attribute parameters
   ...
   class Input implements Runnable
     ...
     if (r1.intersects(r3) || r1.intersects(r4)||r2.intersects(r3)||r2.intersects(r4))
      ...
      public void actionPerformed(ActionEvent e)       
         ...
         // read info from inputstream about currentImage2, vel2, etc.etc
         // write out to outputstream all info about local blue ship - currentImage, vel1 etc etc
